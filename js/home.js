$(document).ready(function(){
    ...
    var active_posts = [ 
        new Post("howdy 1", "askjdkasjdkasj", [1], ["hello1","hey1"], "LA", "thread1", 1, true),
        new Post("howdy 2","asjdhaskjdask", [2], ["hello2","hey2"], "SF", "thread2", 2, true),
        new Post("howdy 3", "aksdjkasjd", [3], ["hello3","hey3"], "MSP", "thread3", 3, true),
        new Post("howdy 4", "asjdkasjdk", [4], ["hello4","hey4"], "PHX", "thread4", 4, true),
    ]

    var past_posts = [ 
        new Post("yo 1", "aksjdaksd", [1], ["hello1","hey1"], "LA", "thread1", 1, false),
        new Post("yo 2", "aksdjaksdj", [2], ["hello2","hey2"], "SF", "thread2", 2, false),
        new Post("yo 3", "aksjdksad", [3], ["hello3","hey3"], "MSP", "thread3", 3, false),
